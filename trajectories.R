setwd("~/Research/DrawRhythm/TickTack/Experiment_1/Participant_03")
library(tidyverse)
scale = 0.5625
...
ggplot(data=traj) + geom_point(mapping=aes(x=x,y=y), color="gray") + 
  geom_point(mapping=aes(x=xGhost,y=yGhost), color="red", shape=".") +
